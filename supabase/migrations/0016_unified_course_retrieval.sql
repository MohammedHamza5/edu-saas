-- ============================================================================
-- Migration: 0016_unified_course_retrieval.sql
-- Description:
-- Replaces get_group_course_progress with a unified retrieval layer that 
-- computes access_state, progress_state, and unlock_source sequentially.
-- ============================================================================
